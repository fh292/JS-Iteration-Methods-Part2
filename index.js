...
// Each transaction is an array containing the transaction type
//("income" or "expense") and the amount.
const transactions = [
  ["income", 1000],
  ["income", 1500],
  ["expense", 500],
...
// Note: Use appropriate JavaScript array iteration methods such as
// filter, reduce, etc., to achieve the desired output for each task.

const netTotal = totalIncome - totalExpenses;
console.log(netTotal);

const greaterThan500 = transactions.filter(
